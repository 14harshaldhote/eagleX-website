    ...
    <section className="pt-24 md:pt-28">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white p-4 sm:p-6 rounded-lg mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 p-6 md:p-12 lg:p-20">
            <Link to="/services/digital-solutions" className="group block w-full md:w-1/3 p-4 bg-white shadow-lg rounded-lg transition-transform transform hover:-translate-y-2">
            ...
            <Link to="/services/it-services" className="group block w-full md:w-1/3 p-4 bg-white shadow-lg rounded-lg transition-transform transform hover:-translate-y-2">
            ...
            <Link to="/services/data-analytics" className="group block w-full md:w-1/3 p-4 bg-white shadow-lg rounded-lg transition-transform transform hover:-translate-y-2">
