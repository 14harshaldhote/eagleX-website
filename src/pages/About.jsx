...
const About = () => {
  return (
    <section className="py-12">
      <div className="bg-deepBlue w-full pt-28">
      ...
      <div className="container mx-auto px-4">
        <div className="p-6 sm:p-8 md:p-16 rounded-lg mb-8">
          <div className="text-center">
            <h3 className="text-4xl sm:text-4xl font-semibold mb-4">Our Vision</h3>
        ...
        <div className="bg-white p-4 sm:p-8 md:p-11 rounded-lg shadow-md mb-8 flex flex-col md:flex-row">
